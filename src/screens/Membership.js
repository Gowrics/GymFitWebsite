		...
		<div className="row justify-content-center">
			<div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
				<div className="card pricecard rounded-0 px-4 py-5 ">
					...
					<h3 className="text-lg font-secondary position-relative mt-2"><sup className="text-sm position-absolute">$</sup>12  <sub>per month</sub></h3>
			...
			<div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
				<div className="card pricecard rounded-0 px-4 py-5 " style={{height:'554px'}}>
					...
					<h3 className="text-lg font-secondary position-relative mt-2"><sup className="text-sm position-absolute">$</sup>29 <sub>per month</sub></h3>
 					...
 					<div className="card-body mt-2">
						...
						<Link to="#" className="btn btn-main "  style={{position:'relative',top:'-22px'}}>Buy Now</Link>					</div>
				</div>
			</div>
			<div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
				<div className="card  pricecard rounded-0 px-4 py-5 ">
					<h4 className="card-title text-capitalize font-weight-normal font-secondary">Gold Pack</h4>
					<h3 className="text-lg font-secondary position-relative mt-2"><sup className="text-sm position-absolute">$</sup>39 <sub>per month</sub></h3>
...
<section className="section pricing bg-gray primg">
	<div className="container">
		<div className="row justify-content-center"  style={{position:"relative",top:'350px'}}>
		<SectionTitle title="Package pricing" line="___" description=""/>
		</div>
		<div className="row justify-content-center">
			<div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
				<div className="card pricecard rounded-0 px-4 py-5 ">
					...
					<h3 className="text-lg font-secondary text-white position-relative mt-2"><sup class="text-sm position-absolute">$</sup>12  <sub>per month</sub></h3>
				...
				<div class="card pricecard rounded-0 px-4 py-5 " style={{height:'554px'}}>
					...
					<h3 class="text-lg font-secondary text-white position-relative mt-2"><sup class="text-sm position-absolute">$</sup>29 <sub>per month</sub></h3>
 					...
 					<div class="card-body mt-2">
						...
						<Link to ="#" class="btn btn-main " style={{position:'relative',top:'-22px'}}>Buy Now</Link>					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
